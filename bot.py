...
# Token đã được tích hợp sẵn theo yêu cầu của bạn
...
def run_30_layers_pipeline(hash_str: str):
    ...
    # Kiểm tra đầu vào tầng 01
    if algo_01_input_validation(clean_hash) == 0.0:
        return None

    # Thực thi lần lượt 30 thuật toán độc lập từ T02 đến T29
    scores = [
...
def handle_message(message):
    ...
    # Hiệu ứng xử lý 30 tầng thuật toán độc lập
    msg = bot.reply_to(message, "⚙️ *[30 Tầng / 30 Thuật toán độc lập]* Đang chạy Pipeline chuyên sâu...", parse_mode="Markdown")
    time.sleep(0.5)

    res_icon = "🟢" if analysis["result"] == "TÀI" else "🔴"
    
    # Giao diện đầu ra chuẩn 3 dòng gọn gàng
    response_text = (
        f"⚡ **Tool TXGAME MD5**\n"
...
if __name__ == "__main__":
    print("Bot đang khởi chạy với 30 hàm thuật toán độc lập...")
